    ...
    if (this.props.location.pathname.slice(1) === "login" || this.props.location.pathname.slice(1) === "signup") {
      ...
      navBar = (<Navbar id="main-nav">
                  <Nav key={1} className="nav-item">
                      ...
                      <NavItem key={4} href="https://github.com/kcha0611" id="nav-item-li-4">Github</NavItem>
                      <NavItem key={5} href="https://www.linkedin.com/in/kencha" id="nav-item-li-5">LinkedIn</NavItem>
